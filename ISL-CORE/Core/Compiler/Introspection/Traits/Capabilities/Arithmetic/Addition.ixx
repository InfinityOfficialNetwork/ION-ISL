export module ION.Core.Compiler.Introspection.Traits.Capabilities.Arithmetic.Addition;

import std;
export import ION.Core.Object;
export import ION.Core.Compiler.Introspection.Traits.Base;

export namespace ION::Core::Compiler::Introspection::Traits::Capabilities::Arithmetic
{
    template <typename T>
