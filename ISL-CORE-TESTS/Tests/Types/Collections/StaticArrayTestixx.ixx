export module ION.Tests.Types.Collections.StaticArrayTest;
...
{
	class StaticArrayTest : public TestBase
	{
	public:
		StaticArrayTest () : TestBase ()
		{
			this->Name = "ION.Core.Types.Collections.StaticArrayTest";
		...
		class SmallSet1 : public TestBase::Test
		{
			...
			{
				ION::Core::Types::Collections::StaticArray<int, 100> a;
		...
		class LargeSet1 : public TestBase::Test
		{
			virtual Result Invoke () override try
			{
				ION::Core::Types::Collections::StaticArray<int, 1000000>* a = new ION::Core::Types::Collections::StaticArray<int, 1000000> ();
